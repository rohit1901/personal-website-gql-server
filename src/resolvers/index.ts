...
export const devResolvers: Resolvers = {
    Query: {
        basics: async (parent: any, args: any, context: AppContext) => RESUME.basics,
        work: async (parent: any, args: any, context: AppContext) => RESUME.work,
        volunteer: async (parent: any, args: any, context: AppContext) => RESUME.volunteer,
        education: async (parent: any, args: any, context: AppContext) => RESUME.education,
        ...
        getReadingStates: async (parent: any, args: any, context: AppContext) => ReadingStates.myReadingStates,
        getLiteralToken: async (parent: any, args: any, context: AppContext) => DEFAULT_LITERAL_TOKEN,
    },
    Mutation: {
        login: (parent: any, args: { email: string, password: string }) => UserLogin.login,
    },
